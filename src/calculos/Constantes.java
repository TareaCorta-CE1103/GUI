...
/**
 * interface que contiene todas las constantes que se puedan ocupar durante
...
public interface Constantes {
    ...
    public static final int R_N=4;
    public static final int Ldoble=5;
    public static final int binariS=6;
    public static final int lineal=7;
    public static final int burbujaS=1;
    public static final int insertS=2;
    public static final int quickS=3;
